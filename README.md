TerminalPoint lets you create beautifully minimalist slides presentations for display in a terminal.  The configuration language is a simple Ruby DSL.
...
```
./terminalpoint presentation.tpt
